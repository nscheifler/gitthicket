...
func TestStagePromoteExportAndDiff(t *testing.T) {
	...
	runGit(t, sourceDir, "update-ref", tempRef, "HEAD")
	runGit(t, sourceDir, "bundle", "create", bundlePath, tempRef)
	runGit(t, sourceDir, "update-ref", "-d", tempRef)
	...
	if err := stage.Promote(ctx, hashes); err != nil {
